...
//#import "D:\\Program Files\\Microsoft Office\\Office16\\EXCEL.EXE" no_namespace
...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xc60, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_DISPATCH VTS_DISPATCH VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0xc5f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Timeline, Values, &ForecastStart, &ForecastEnd, &ConfInt, &Seasonality, &DataCompletion, &Aggregation, &ChartType, &ShowStatsTable);
	}
